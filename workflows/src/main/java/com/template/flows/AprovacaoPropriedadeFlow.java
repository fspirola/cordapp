...
public class AprovacaoPropriedadeFlow extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        if(proprietario.getName().toString().contains("Bank")) {
            propriedadeState = inputStateAndRef.getState().getData().aprovacaoBanco(new Boolean(isAprovado).
                    toString());
        }else if(proprietario.getName().toString().contains("Surveyor")){
            propriedadeState = inputStateAndRef.getState().getData().aprovacaoDoEngenheiro(new Boolean(isAprovado).
                    toString());
        }
